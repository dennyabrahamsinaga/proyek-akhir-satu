              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  if (isset($_GET['pesan'])) {
                    ...
                    if ($pesan == 'gagal') {
                  ?>
                      <div class="alert alert-danger text-center">Username/password Anda salah.</div>
                    <?php } else { ?>
                  ...
                  <form action="" method="POST" class="user">
                    ...
                    <div class="form-group">
                      <div class="custom-control custom-checkbox small">
                        ...
                        <label class="custom-control-label" for="customCheck" nam="remember">Remember Me</label>
                      </div>
                    </div>
